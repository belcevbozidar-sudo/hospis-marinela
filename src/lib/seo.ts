...
export const ROUTE_META: Record<string, RouteMeta> = {
  "/": {
    title: 'Хоспис Маринела София – денонощни грижи за възрастни хора',
    description:
  ...
  "/news": {
    title: 'Новини | Хоспис "Маринела"',
    description:
      'Актуална информация и новини от Хоспис "Маринела" — събития, инициативи и важни съобщения за пациенти и близки.',
  },
  "/grizhi-sled-insult": {
    title: "Грижа след инсулт – рехабилитация в хоспис София",
    description:
      'Специализирана грижа и поддържаща рехабилитация след инсулт в Хоспис "Маринела", София. Денонощно наблюдение, квалифицирани рехабилитатори и индивидуален подход.',
  },
  "/palliativni-grizhi": {
    title: "Палиативни грижи за онкоболни – хоспис София",
    description:
      'Палиативни грижи и облекчаване на страданието за онкологично болни пациенти в Хоспис "Маринела", София. Лекарски контрол на болката и денонощна грижа.',
  },
  "/demenciya-alzhaimer": {
    title: "Грижа при деменция и Алцхаймер – хоспис София",
    description:
      'Специализирана грижа за пациенти с деменция и Алцхаймер в Хоспис "Маринела", София. Сигурна среда, денонощно наблюдение и внимание към всеки пациент.',
  },
  "/sledoperativno-vazstanovyavane": {
    title: "Следоперативно възстановяване – хоспис София",
    description:
      'Грижа и възстановяване след операция в Хоспис "Маринела", София. Денонощно медицинско наблюдение, рехабилитация и помощ през периода на възстановяване.',
  },
  "/404": {
